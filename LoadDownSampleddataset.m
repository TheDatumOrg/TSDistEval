function DS = LoadDownSampleddataset(datasetname)

    TRAIN = load(['./UCR2018-NEW-DownSampled/',datasetname,'/',datasetname,'_TRAIN']);
    TEST  = load(['./UCR2018-NEW-DownSampled/',datasetname,'/',datasetname,'_TEST']);
