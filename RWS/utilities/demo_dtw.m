...
fprintf('Using Matlab dtw: distance=%f, running time=%f\n',d1,t1);
fprintf('Using C/MEX dtw: distance=%f, running time=%f\n',d2,t2);
fprintf('Using Matlab Internal dtw: distance=%f, running time=%f\n',d3,t3);
